...
var googleanalytics = angular.module('wpIonic', ['ionic', 'ionic-fancy-select', 'ngIOS9UIWebViewPatch', 'wpIonic.controllers','app.directives', 'app.filters', 'wpIonic.services', 'ionic.contrib.drawer', 'ngCordova'])

.run(function($ionicPlatform, $ionicPopup, $cordovaStatusbar) {
  $ionicPlatform.ready(function() {
    ...
    if(typeof analytics !== 'undefined') {
		...
		$cordovaStatusbar.styleHex('#60bbe2;') //light blue
  });
